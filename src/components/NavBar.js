        ...
        <div className="flex w-full flex-wrap items-center justify-between px-3">
          ...
          <div
            ...
            <ul
              ...
              {/* This will check if user in logged in or not  */}
              {
              ...
              {(!(localStorage.getItem("authToken")))
                ...
                :
                <div className='text-neutral-500 transition duration-200 hover:text-neutral-700 hover:ease-in-out focus:text-neutral-700 cursor-pointer' onClick={handleLogout}>
                  Logout
                </div>
          ...
          <div className="relative flex items-center">
            {/* <!-- Cart Icon --> */}
            <div
              className="mr-4 text-neutral-600 transition duration-200 hover:text-neutral-700 hover:ease-in-out focus:text-neutral-700 disabled:text-black/30 motion-reduce:transition-none dark:text-neutral-200 dark:hover:text-neutral-300 dark:focus:text-neutral-300 [&.active]:text-black/90 dark:[&.active]:text-neutral-400 cursor-pointer"
            ...
            <div className="relative" data-te-dropdown-ref>
              ...
              <ul
                ...
                <li>
                  <Link className="block w-full whitespace-nowrap bg-transparent px-4 py-2 text-sm font-normal text-neutral-700 hover:bg-neutral-100 active:text-neutral-800 active:no-underline disabled:pointer-events-none disabled:bg-transparent disabled:text-neutral-400 dark:text-neutral-200 dark:hover:bg-white/30"
                    to="#"
                    data-te-dropdown-item-ref
                  >Action</Link>
                </li>
